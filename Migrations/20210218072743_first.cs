        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BelongGroup = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinalDocumentationSRC = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExamGrade = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FinalProjects_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProposedProjects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProposedProjects_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinalProjects_StudentId",
                table: "FinalProjects",
                column: "StudentId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProposedProjects_StudentId",
                table: "ProposedProjects",
                column: "StudentId");
